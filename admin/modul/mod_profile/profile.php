            ...
            <form method="get" action='<?php echo '?module=user&'.$_SERVER['PHP_SELF'] ?>'>
              <div class="table-responsive">
                <table class="hover">
                  ...
                  <tbody>
                  <?php
                    $result=mysql_query("SELECT * FROM admin WHERE admin_username='$_SESSION[username]'");
                    $jmldata = mysql_num_rows(mysql_query("SELECT * FROM admin WHERE admin_username='$_SESSION[username]'"));
