...
$aksi="modul/mod_subrogasi/subrogasilunas_aksi.php";
...
switch($_GET['act']) {
  ...
  ?>
  <div class="cl-mcont">
    <h2 class="text-center">Lunas Piutang</h2>
    <div class="row">
      <div class="col-sm-12 col-md-12">
        <div class="block-flat">
            <a class="btn btn-success" href="modul/mod_subrogasi/subrogasi_lunas_pdf.php"><i class="fa fa-print"></i> Print PDF</a>
          <a class="btn btn-success" href="modul/mod_subrogasi/subrogasi_lunas_excel.php"><i class="fa fa-file"></i> Export to Excel</a>
          <div class="content">
            <!-- ========== Button ========== -->
            <form>
              <div class='btn-navigation'>
                <div class='pull-right'>
                  <a class="btn btn-primary" href="?module=subrogasilunas"><i class="fa fa-times-circle"></i> Bersihkan Pencarian</a>
                </div>
              </div>
              <div class='row'>
                <div class='btn-search'>Cari Berdasarkan :</div>
                  <div class='col-md-2 col-sm-12'>
                    <select name="produk2" class="form-control input-sm">
                  ...
                  <div class='col-md-2 col-sm-12'>
                    <select name="search2" class="form-control input-sm">
                  ...
                  <div class='col-md-2 col-sm-12'>
                    <div class="input-group">
                      ...
                      <input type="text" name="kata2" class="form-control" value=""/>
              ...
              <div class="table-responsive">
                <table class="hover">
                  ...
                  <tbody>
                  <?php
                  if (empty(isset($_GET['kata2']))) {
                    $p      = new Paging;
                    $batas  = 10;
                    $posisi = $p->cariPosisi($batas);

                    $result=mysql_query("SELECT * FROM subrogasi WHERE subrogasi_sisapiutang < 1 LIMIT $posisi,$batas");
                    $jmldata = mysql_num_rows(mysql_query("SELECT * FROM subrogasi WHERE subrogasi_sisapiutang < 1"));
                    if(mysql_num_rows($result) === 0) {
                    ?>
                    <tr>
                      <td class="center" colspan="7">Data kosong...</td>
                    </tr>
                    <?php } else {
                    $no = $posisi+1;
                      ...
                      <td width=180 align="center">
                        ...
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu pull-right" role="menu">
                            ...
                            <li>
                              <a href="?module=subrogasilunas&act=edit&id=<?php echo $r['subrogasi_id'] ?>" title="Edit"><i class='fa fa-pencil'></i> Edit</a>
                            </li>
                            <li>
                              <a href="?module=subrogasilunas&act=detail&id=<?php echo $r['subrogasi_id'] ?>" title="Detail"><i class='fa fa-eye'></i> Detail</a>
                            </li>
                            <li>
                ...
                <?php } else {
                  ...
                  $posisi = $p->cariPosisi($batas);
                  $search2 = $_GET['kata2'];
                  $produk2 = $_GET['produk2'];
                  $searchkategori2 = $_GET['search2'];
                  if ($searchkategori2 == 'subrogasi_nosp') {
                    $result=mysql_query("SELECT * FROM subrogasi WHERE subrogasi_nosp LIKE '%$search2%' AND product_id LIKE '%$produk2%' AND subrogasi_sisapiutang < 1 LIMIT $posisi,$batas");
                  } else {
                    $result5 =mysql_query("SELECT * FROM debitur WHERE debitur_name LIKE '%$search2%'");
                    if(mysql_num_rows($result5) === 0) {
                      $result=mysql_query("SELECT * FROM subrogasi WHERE debitur_id LIKE '%aaaaaaaaaaaaaaaaaaaaaaaaaa%' AND subrogasi_sisapiutang < 1 LIMIT $posisi,$batas");
                    } else {
                      while ($r5=mysql_fetch_array($result5)) {
                        $result=mysql_query("SELECT * FROM subrogasi WHERE debitur_id LIKE '%$r5[debitur_id]%' AND product_id LIKE '%$produk2%' AND subrogasi_sisapiutang < 1 LIMIT $posisi,$batas");
                      }
                    }
                  }
                  if(mysql_num_rows($result) === 0) {
                    if ($searchkategori2 == 'subrogasi_nosp') {
                      $jmldata = mysql_num_rows(mysql_query("SELECT * FROM subrogasi WHERE subrogasi_nosp LIKE '%$search2%' AND product_id LIKE '%$produk2%' AND subrogasi_sisapiutang < 1"));
                    } else {
                      $result5 =mysql_query("SELECT * FROM debitur WHERE debitur_name LIKE '%$search2%'");
                      while ($r5=mysql_fetch_array($result5)) {
                        $jmldata = mysql_num_rows(mysql_query("SELECT * FROM subrogasi WHERE debitur_id LIKE '%$r5[debitur_id]%' AND product_id LIKE '%$produk2%' AND subrogasi_sisapiutang < 1"));
                      }
                    }
                  ?>
                  <tr>
                  ...
                  <?php
                    ...
                    $jmldata = mysql_num_rows(mysql_query("SELECT * FROM subrogasi WHERE debitur_id LIKE '%$r5[debitur_id]%' AND product_id LIKE '%$produk%' AND subrogasi_sisapiutang < 1"));
                    $jmlhalaman  = $p->jumlahHalaman($jmldata, $batas);
                    $linkHalaman = $p->navHalaman($_GET['halaman'], $jmlhalaman);
                  }?>
                </tbody>
  ...
  <div class="cl-mcont">
    <div class="row">
      <div class="col-md-12">
        <div class="block-flat">
          <div class="content">
            <form role="form" class="form-horizontal" action="<?php echo $aksi ?>?module=subrogasilunas&act=edit" method="post" enctype="multipart/form-data" parsley-validate novalidate>
          ...
          <div class='center'>
            ...
            <input class="btn btn-default" type="reset" name="batal" value="Batalkan" onclick="location.href='?module=subrogasilunas'"/>
          </div>
        </div>
      </div>
    </div>
  ...
  <?php
    ...
    header("location: admin/media.php?module=subrogasilunas");
  }
  break;
  ...
  <div class="cl-mcont">
    <div class="row">
      <div class="col-md-12">
        <div class="block-flat">
          <div class="content">
            <form role="form" class="form-horizontal" action="?module=subrogasilunas&act=edit&id=<?php echo $r['subrogasi_id'] ?>" method="post" enctype="multipart/form-data" parsley-validate novalidate>
