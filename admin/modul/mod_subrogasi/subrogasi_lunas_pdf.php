...
<title>Subrogasi Piutang (Sudah Lunas)</title>
</head>
<body>


			<div class="title">Piutang Subrogasi (Sudah Lunas)</div>
				<div class="center">
								<table class="border">
									<thead>
										<tr>
									...
									<tbody>
									<?php
										$result=mysql_query("SELECT * FROM subrogasi WHERE subrogasi_sisapiutang < 1");
										...
										<tr>
											...
											<td style="text-align:right">Rp<?php echo $sisapiutang ?>,00</td><td style="text-align:right">Rp<?php echo $totalpiutang ?>,00</td>
											<?php $no++;
										 ?>
										</tr>
										<?php }
									...
									<tbody>
										<tr>
											<?php
												$result = mysql_query('SELECT SUM(subrogasi_totalpiutang) AS subrogasi_totalpiutang FROM subrogasi WHERE subrogasi_sisapiutang < 1'); 
												$result2 = mysql_query('SELECT SUM(subrogasi_sisapiutang) AS subrogasi_sisapiutang FROM subrogasi WHERE subrogasi_sisapiutang < 1'); 
												...
												$sum3 = $sum - $sum2;
											?>
											<td colspan="5">Total Piutang yang sudah lunas</td>
											<td colspan="1">Rp<?php echo format_rupiah($sum3); ?>,00</td>
										</tr>
									</tbody>
								</table>
...
<?php
$filename="Subrogasi Piutang (Sudah Lunas).pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
