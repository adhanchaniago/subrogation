...
switch($_GET['act']) {
              ...
              <div class="table-responsive">
                <table class="hover">
                  ...
                  if (empty(isset($_GET['kata']))) {
                    ...
                    $result=mysql_query("SELECT * FROM admin WHERE admin_level='user' LIMIT $posisi,$batas");
                    $jmldata = mysql_num_rows(mysql_query("SELECT * FROM admin WHERE admin_level='user'"));
                ...
                <?php } else {
                  ...
                  $result=mysql_query("SELECT * FROM admin WHERE admin_name LIKE '%$search%' AND admin_level='user' LIMIT $posisi,$batas");
                  if(mysql_num_rows($result) === 0) {
                  $jmldata = mysql_num_rows(mysql_query("SELECT * FROM admin WHERE admin_name LIKE '%$search%' AND admin_level='user'"));
                  ?>
                  <tr>
                    <td class="center" colspan="10">Data kosong...</td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td><?php echo $r['admin_username'] ?></td>
                    <td>*****</td>
                    <td class="center"><?php echo $r['admin_level'] ?><?php echo $_GET['kata'] ?></td>
                    <td align="center">
                      <!-- ========== EDIT DETAIL HAPUS ========== -->
                      <div class="btn-group">
                        <button type="button" class="btn btn-default btn-xs">Actions</button>
  ...
  case "edit":
  if ($_SESSION['level']=='admin') {
  $result =mysql_query("SELECT * FROM admin WHERE admin_username='$_GET[id]'");
